...
const GsapTimeline = () => {
  ...
  const timeline = gsap.timeline({
    //These options cause the animation to reverse after completion. This means the timeline plays forward, then reverses back to the starting position, creating a back-and-forth effect.
    repeat :-1,
    repeatDelay:1,
    yoyo:true
  })
